...
import {
    checkIfCurtainShouldBeHidden,
    createCurtain,
    tryHideCurtain,
    isShapeInsideViewport,
    tryShowCurtain,
    updateCurtainAttention
} from "./logic";
